 ...
 * 
 * @export
 * @interface GetServicePointByIdResponseBodyServicePointHoursOfOperationFridayInner
 */
export interface GetServicePointByIdResponseBodyServicePointHoursOfOperationFridayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof GetServicePointByIdResponseBodyServicePointHoursOfOperationFridayInner
     */
    'open'?: string;
    /**
     * Closing time
