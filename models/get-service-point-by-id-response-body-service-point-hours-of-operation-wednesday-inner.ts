 ...
 * 
 * @export
 * @interface GetServicePointByIdResponseBodyServicePointHoursOfOperationWednesdayInner
 */
export interface GetServicePointByIdResponseBodyServicePointHoursOfOperationWednesdayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof GetServicePointByIdResponseBodyServicePointHoursOfOperationWednesdayInner
     */
    'open'?: string;
    /**
     * Closing time
