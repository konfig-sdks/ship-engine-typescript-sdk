 ...
 * 
 * @export
 * @interface GetServicePointByIdResponseBodyServicePointHoursOfOperationMondayInner
 */
export interface GetServicePointByIdResponseBodyServicePointHoursOfOperationMondayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof GetServicePointByIdResponseBodyServicePointHoursOfOperationMondayInner
     */
    'open'?: string;
    /**
     * Closing time
