 ...
 * 
 * @export
 * @interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationWednesdayInner
 */
export interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationWednesdayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof ListServicePointsResponseBodyServicePointsInnerHoursOfOperationWednesdayInner
     */
    'open'?: string;
    /**
     * Closing time
