 ...
 * @enum {string}
 */
export type AncillaryServiceEndorsement = 'none' | 'return_service_requested' | 'forwarding_service_requested' | 'address_service_requested' | 'change_service_requested' | 'leave_if_no_response'
