 ...
 * @enum {string}
 */
export type CarrierName = 'access_worldwide' | 'amazon_buy_shipping' | 'amazon_shipping_uk' | 'apc' | 'asendia' | 'australia_post' | 'canada_post' | 'dhl_ecommerce' | 'dhl_express' | 'dhl_express_au' | 'dhl_express_ca' | 'dhl_express_uk' | 'dpd' | 'endicia' | 'fedex' | 'fedex_uk' | 'firstmile' | 'imex' | 'newgistics' | 'ontrac' | 'purolator_canada' | 'royal_mail' | 'rr_donnelley' | 'seko' | 'sendle' | 'stamps_com' | 'ups'
