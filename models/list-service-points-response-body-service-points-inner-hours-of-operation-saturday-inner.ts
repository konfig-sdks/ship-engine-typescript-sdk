 ...
 * 
 * @export
 * @interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationSaturdayInner
 */
export interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationSaturdayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof ListServicePointsResponseBodyServicePointsInnerHoursOfOperationSaturdayInner
     */
    'open'?: string;
    /**
     * Closing time
