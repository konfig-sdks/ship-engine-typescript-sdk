 ...
 * 
 * @export
 * @interface GetServicePointByIdResponseBodyServicePointHoursOfOperationThursdayInner
 */
export interface GetServicePointByIdResponseBodyServicePointHoursOfOperationThursdayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof GetServicePointByIdResponseBodyServicePointHoursOfOperationThursdayInner
     */
    'open'?: string;
    /**
     * Closing time
