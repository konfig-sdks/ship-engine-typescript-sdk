...
import { GetServicePointByIdResponseBodyServicePointHoursOfOperation } from './get-service-point-by-id-response-body-service-point-hours-of-operation';
...
type GetServicePointByIdResponseBodyServicePointFeaturesEnum = 'drop_off_point' | 'pickup_point' | 'print_services' | 'after_hours_locker' | 'after_hours_dropbox'
type GetServicePointByIdResponseBodyServicePointTypeEnum = 'pudo' | 'locker'
