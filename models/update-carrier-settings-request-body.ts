...
import { DhlExpressAccountSettings } from './dhl-express-account-settings';
import { FedexAccountSettings } from './fedex-account-settings';
import { SmartPostHub } from './smart-post-hub';
import { UpdateAmazonBuyShippingRequestBody } from './update-amazon-buy-shipping-request-body';
import { UpdateNewgisticsSettingsRequestBody } from './update-newgistics-settings-request-body';
import { UpsAccountSettings } from './ups-account-settings';
 ...
 * @export
 */
export type UpdateCarrierSettingsRequestBody = DhlExpressAccountSettings | FedexAccountSettings | UpdateAmazonBuyShippingRequestBody | UpdateNewgisticsSettingsRequestBody | UpsAccountSettings;
