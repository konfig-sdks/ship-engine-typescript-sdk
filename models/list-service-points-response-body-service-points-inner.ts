...
import { ListServicePointsResponseBodyServicePointsInnerHoursOfOperation } from './list-service-points-response-body-service-points-inner-hours-of-operation';
...
type ListServicePointsResponseBodyServicePointsInnerFeaturesEnum = 'drop_off_point' | 'pickup_point' | 'print_services' | 'after_hours_locker' | 'after_hours_dropbox'
type ListServicePointsResponseBodyServicePointsInnerTypeEnum = 'pudo' | 'locker'
