 ...
 * 
 * @export
 * @interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationSundayInner
 */
export interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationSundayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof ListServicePointsResponseBodyServicePointsInnerHoursOfOperationSundayInner
     */
    'open'?: string;
    /**
     * Closing time
