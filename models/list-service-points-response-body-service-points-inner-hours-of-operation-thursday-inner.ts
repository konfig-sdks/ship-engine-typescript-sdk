 ...
 * 
 * @export
 * @interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationThursdayInner
 */
export interface ListServicePointsResponseBodyServicePointsInnerHoursOfOperationThursdayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof ListServicePointsResponseBodyServicePointsInnerHoursOfOperationThursdayInner
     */
    'open'?: string;
    /**
     * Closing time
