 ...
 * 
 * @export
 * @interface GetServicePointByIdResponseBodyServicePointHoursOfOperationSaturdayInner
 */
export interface GetServicePointByIdResponseBodyServicePointHoursOfOperationSaturdayInner {
    /**
     * Opening time
     * @type {string}
     * @memberof GetServicePointByIdResponseBodyServicePointHoursOfOperationSaturdayInner
     */
    'open'?: string;
    /**
     * Closing time
